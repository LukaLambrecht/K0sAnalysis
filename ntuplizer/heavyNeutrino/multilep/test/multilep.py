...
#inputFile         = '/store/data/Run2016C/DoubleMuon/MINIAOD/HIPM_UL2016_MiniAODv2-v1/130000/18D152F3-357C-B94C-8FFB-58785F0C0C13.root'
...
process.blackJackAndHookers = cms.EDAnalyzer('multilep',
  ...
  electronsEffAreas             = cms.FileInPath('RecoEgamma/ElectronIdentification/data/Fall17/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_94X.txt'),
  electronsEffAreas_Summer16    = cms.FileInPath('RecoEgamma/ElectronIdentification/data/Summer16/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_80X.txt'),
  electronsEffAreas_Spring15    = cms.FileInPath('RecoEgamma/ElectronIdentification/data/Spring15/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_25ns.txt'),
