...
# - names of the trees (arbitrarily many)
...
def addpuscale(infilename,year):
    ...
    if(year not in ['2016','2017','2018']):
        print('### ERROR ###: could not interpret first argument: '+year)
        print('               (supposed to represent data taking year)')
	return None        

    ### open the PU hist for data
    gpath = '/storage_mnt/storage/user/llambrec/Kshort/python/pureweighting'
