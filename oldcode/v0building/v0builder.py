...
for i in range(nevents):
    ...
    nk0s += len(k0scollection.v0collection)
    nlambda += len(lambdacollection.v0collection)
...
print('Found {} K0s candidates'.format(nk0s))
print('Found {} Lambda candidates'.format(nlambda))
